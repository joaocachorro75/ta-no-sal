...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f7f3ea] text-[#063b43]">
      <header className="absolute inset-x-0 top-0 z-20"><div className="container flex h-20 items-center justify-between"><Brand /><Link href="/admin" className="rounded-full border border-[#0b6876]/15 bg-white/65 px-3.5 py-2 text-xs font-bold text-[#0b6876] backdrop-blur-md transition hover:bg-white">Área do parceiro</Link></div></header>
